...
public class YmlUtil {
    // 定义配置文件和对应的YamlConfiguration对象
    public static File fileLimitPoke = new File(Main.plugin.getDataFolder(), "LimitPoke.yml");
    public static YamlConfiguration limitPokeEventWorld = YamlConfiguration.loadConfiguration(fileLimitPoke);
    ...
    // 设置 limitPoke 配置
    public static void setLimitPoke(YamlConfiguration limitPokeEventWorld) {
        YmlUtil.limitPokeEventWorld = limitPokeEventWorld;
    }
    ...
    public static void reloadConfigAll() {
        ...
        // 重置 LimitPoke 配置
        File limitPokeEventWorldFile = new File(Main.plugin.getDataFolder(), "LimitPoke.yml");
        YamlConfiguration newLimitPokeConfig = YamlConfiguration.loadConfiguration(limitPokeEventWorldFile);
        setLimitPoke(newLimitPokeConfig);
